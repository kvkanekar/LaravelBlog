...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
		...
		<div class="links">
				<a href="/adminlist/{{ $blog->user_id }}">Home</a>
			</div>
			...
			<form action="/edit/<?php echo $blog->id;?>" method="post">
				...
				<input type="hidden" name="blog_id" value="{{ $blog->id }}">
				  ...
				  <div class="form-title">
					...
					<input type="text" class="form-control" name="post" id="post" value = '<?php echo $blog->post;?>'>
				  </div>
